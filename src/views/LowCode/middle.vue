<template>
  <div class="app-middle">
    <div class="actions">
      <el-button size="medium" v-if="!editing" @click="editing = true">
        开始编辑
      </el-button>
      <el-button size="medium" v-if="editing" @click="showDemo">
        最终展示
      </el-button>
      <el-button size="medium" @click="clear">清空</el-button>
      <el-button size="medium" type="primary" @click="showSchema = true">
        查看schema
      </el-button>
    </div>
    <div v-if="!editing" class="playground-demo">
      <render-components
    ...
    >
      <el-form label-width="100px">
        <draggable :list="componentData" animation="300">
          ...
          >
            ...
            <el-button-group ref="btnGroup" class="item-actions">
              <el-button
                type="primary"
                size="mini"
    ...
    <!-- 弹窗 -->
    <el-dialog title="schema" :visible.sync="showSchema" width="60%">
      <pre ref="schema" class="schema-display" contenteditable="true">{{
        schema
      }}</pre>
      <!-- 隐藏input用于复制 -->
      <textarea class="schema-input" ref="schemaInput" type="text" />
