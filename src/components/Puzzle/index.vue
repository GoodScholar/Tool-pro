...
<template>
  ...
  >
    <div class="vue-auth-box_" @mousedown.stop @touchstart.stop>
      <div class="title-box">请完成安全验证</div>
      <div class="body-box">
        <div class="auth-body_" :style="`height: ${canvasHeight}px`">
          ...
          ></div>
          <i class="el-icon-refresh-right reset_" @click="reset"></i>
        </div>
